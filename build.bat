...
cmake -G Ninja "-DCMAKE_MAKE_PROGRAM:FILEPATH=!NINJA_EXE!" -S "%ROOT%." -B "!BUILD_DIR!" -DCMAKE_BUILD_TYPE=!BUILD_TYPE! -DCPU_TARGET=386 -DBOARD=!BOARD! -DVIDEO_MODE=!VIDEO_MODE! -DAUDIO_TYPE=!AUDIO! -DCPU_SPEED=!CPU_SPEED! -DPSRAM_SPEED=!PSRAM_SPEED! -DFORCE_HDMI=!FORCE_HDMI! -DFORCE_VGA=!FORCE_VGA! -DDEBUG_ENABLED=!DEBUG! -DDIAG_ENABLED=!DIAG! -DEMM=!EMM! -DNO_PAGING=!NO_PAGING!
